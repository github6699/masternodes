...
port = "11888"
rpcuser = "sovuser"
datadir = "/root/.sovcore"
config_file = "sov.conf"
cli = "sov-cli"
coind = "sovd"
walletUrl = "https://github.com/SovCoinX/SovCoin/releases/download/%s" % (walletVer)
walletFile = "sov-mn-%s-ubuntu.tar.gz" % (walletVer)
ticker = "SOV"
...
def removeOldFiles():
    ...
    subprocess.call("rm -rf %s /usr/local/bin/sov*" % (datadir), shell=True)
...
def procFile(data):
    ...
    subprocess.call("mv /tmp/sovd /usr/local/bin/", shell=True)
    subprocess.call("mv /tmp/sov-cli /usr/local/bin/", shell=True)
    subprocess.call("chmod +x /usr/local/bin/sov*", shell=True)
...
def configureMasterNode():
    ...
    f.write("addnode=23.138.32.32:11888\naddnode=108.166.170.169:11888\naddnode=192.99.19.133:11888\naddnode=80.211.93.59:11888\naddnode=45.76.32.201:11888\naddnode=95.179.151.54:11888\naddnode=108.61.142.16:11888\naddnode=154.16.7.176:11888")
    f.close()
    systemdScript()
